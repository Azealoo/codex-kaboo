...
/**
 * Every card metric the backend's `stats.summary` computes, in a fixed order. Owned here (not in
 * `web/convex`) so the web dashboard and the mobile app can label the same key the same way without
